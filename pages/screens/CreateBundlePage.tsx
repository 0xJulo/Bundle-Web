            ...
            <div className='mb-8 md:w-1/2'>
                ...
                <div>
                    ...
                    <div className='mt-4'>
                        ...
                        <p>You may check price data or any other data to start your bundle</p>
                    </div>
                </div>
                <hr className='my-8'/>
                {/* Condition */}
                <div>
                    ...
                    <div className='mt-4'>
                        ...
                        <p>This option can be used to check a inputted wallet for conditions such as the amount of assets held, transactions made, or the presence of an NFT</p>
                    </div>
                    <div className='mt-4'>
                        <input
                            type='radio'
                        ...
                        <p>You may check the price of one asset against another, or the total volume of an NFT project for example</p>
                    </div>
                    <div>
                ...
                <div>
                    ...
                    <p>An action will be taken based off your trigger and any conditions you have set out. All conditions, if applicable, must be met for the action to be taken.</p>
                    <p className='font-bold'>Dev Notes - this could be conditional depending on choices previously</p>
                    <div className='mt-4'>
                        <input
                            type='radio'
                        ...
                        <p>Send a transaction to another wallet, such as friend or co-worker</p>
                    </div>
                    <div className='mt-4'>
                        <input
                            type='radio'
                        ...
                        <p>Buy or sell tokens or NFTs when previoud conditions have been met</p>
                    </div>
                    <div className='mt-4'>
                        <input
                            type='radio'
